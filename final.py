...
if __name__ == "__main__":
    input_pdf = "file04.pdf"
    output_json_path = f"{input_pdf.replace('.pdf', '')}.json"

    print(f"Analyzing '{input_pdf}' with the definitive hybrid logic...")
    extractor = UltimateExtractor(input_pdf)
